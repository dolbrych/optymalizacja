...
int main()
{
  int n,b,c,d;
	scanf("%d", &n);
	// zakladamy ze w kazdej komorce mamy wiadomosc czy na danym polu stoi hetman czy nie
	//nastepnie inaczej numerujemy szachownice niz zwyczajnie
	int a[n][n];
	//maksymalizujemy sume
	printf("Maximize\n sum :");
	for (b=0;b<n;b++)
	  for(c=0;c<n;c++)
	    printf("+a%d%d,b,c ");
